...
class SupAccountsTest(TestCase):
    ...
    def test_accountExists(self):
        response = self.client.post("/SupAccounts/", {"username": self.user.username, "password": self.user.password,
    ...
    def test_createAccount(self):
        response = self.client.post("/SupAccounts/", {"username": "user1", "password": "password1",
    ...
    def test_emptyUsername(self):
        response = self.client.post("/SupAccounts/", {"username": "", "password": "password1",
                                    "email": "user1@uwm.edu", "role": "instructor"})
    ...
    def test_emptyPassword(self):
        response = self.client.post("/SupAccounts/", {"username": "user1", "password": "",
                                    "email": "user1@uwm.edu", "role": "instructor"})
