...
class SupCourseTest(TestCase):
    ...
    def test_courseExists(self):
        response = self.client.post("/SupCourses/", {"cor_id": self.course.courseid, "cor_name": self.course.coursename,
    ...
    def test_createCourse(self):
        response = self.client.post("/SupCourses/", {"cor_id": "337", "cor_name": "System Programming", "cor_sched": "TR @ 1:00 - 1:50", "cor_cred": "3"})
    ...
    def test_emptyCourseid(self):
        response = self.client.post("/SupCourses/", {"cor_id": "", "cor_name": "System Programming", "cor_sched": "TR @ 1:00 - 1:50", "cor_cred": "3"})
    ...
    def test_emptyCoursename(self):
        response = self.client.post("/SupCourses/", {"cor_id": "337", "cor_name": "", "cor_sched": "TR @ 1:00 - 1:50", "cor_cred": "3"})
    ...
    def test_emptyCourseschedule(self):
        response = self.client.post("/SupCourses/", {"cor_id": "337", "cor_name": "System Programming", "cor_sched": "", "cor_cred": "3"})
    ...
    def test_emptyCourseid(self):
        response = self.client.post("/SupCourses/", {"cor_id": "337", "cor_name": "System Programming", "cor_sched": "TR @ 1:00 - 1:50", "cor_cred": ""})
